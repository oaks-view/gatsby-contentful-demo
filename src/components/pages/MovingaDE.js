...
const MovingaDE = props => {
  ...
  const section2 = sections.find(x =>
    x.slug.startsWith('just-move-with-movinga')
  )
  const section3 = sections.find(x =>
    x.slug.startsWith('basic-package-and-additional-services')
  )
  const section4 = sections.find(x =>
    x.slug.startsWith('always-included-in-your-move')
  )
  const section5 = sections.find(x => x.slug.startsWith('optional-services'))
  const section6 = sections.find(x =>
    x.slug.startsWith(
      'movinga-move-your-home-professional-moving-companies-all-over-germany'
    )
  )
  const section7 = sections.find(x => x.slug.startsWith('heres-how-it-works'))
  const section8 = sections.find(x =>
    x.slug.startsWith('thats-what-our-customers-say')
  )
  ...
  return (
    <>
          ...
          <div className="div-headline">
            ...
            <div className="row-68 main w-row">
              ...
              <div className="column-168 w-col w-col-10 w-col-small-10 w-col-tiny-10">
                <p className="text-phone-cta">
                  {section1.subSections[0].title}
                </p>
        ...
        <div className="container-general w-container">
          ...
          <div className="columns-icons w-hidden-tity w-row">
            {section2.subSections.map((item, i) => (
              <div
                className={`column-center-icon w-col w-col-${isOdd(i) ? 3 : 2}`}
                key={i}
              >
                <img
          ...
          <div className="columns-text w-row">
            {section2.subSections.map((item, i) => (
              <div
                className={`column-text w-col w-col-${isOdd(i) ? 3 : 2}`}
                key={i}
              >
                <div className="subtitle-general small">{item.title}</div>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="white-background">
            <div className="columns-services w-row">
              <div className="column-services w-col w-col-6 w-col-small-small-stack">
                <div className="subtitle-general left-subtitle">
                  {section4.title}
                </div>
                {section4.subSections.map((item, i) => (
                  <div className="columns-services w-row" key={i}>
                    <div className="column-checks centered w-col w-col-1 w-col-small-1 w-col-tiny-1">
                      <img
                        src={item.backgroundImage.file.url}
                        alt=""
                        className="image-89"
              ...
              <div className="column-services w-col w-col-6 w-col-small-small-stack">
                ...
                {section5.subSections.map((item, i) => (
                  <div className="columns-services w-row" key={i}>
                    <div className="column-checks w-col w-col-1 w-col-small-1 w-col-tiny-1">
                      <img
                        src={item.backgroundImage.file.url}
                        alt=""
                        className="image-89"
      ...
      <div className="section-general blue-background">
        <div className="container-general w-container">
          <div className="text-banner">{section6.title}</div>
          <div className="div-cta">
            <a href="#heroplus" className="cta-general w-button">
              {section6.subSections[0].title}
            </a>
          </div>
        </div>
      </div>
          ...
          <div className="columns-general center w-row">
            ...
            <div className="column-general w-col w-col-8">
              {section7.subSections.map((item, i) => (
                <>
                  <div className="subtitle-general left-subtitle" key={i}>
                    {item.title}
                  </div>
      ...
      <div className="section-general gray-background">
        <div className="container-general w-container">
            ...
            {section8.subSections.map((item, i) => (
              <div className="column-general w-col w-col-4" key={i}>
                <div className="div-testimonials">
                  <img src={item.backgroundImage.file.url} alt="" />
                  <div className="text-general">{item.body.body}</div>
          ...
          {/* Todo Translate */}
          <div className="div-cta">
            <a href="/bewertungen" className="cta-general w-button">
              Read more
            </a>
          </div>
        </div>
      ...
      <div className="section-general badges">
        <div className="container-general w-container">
          <div className="columns-trusted-shop-big w-row">
            {section9.subSections
              .slice(0, section9.subSections.length - 1)
              .map((item, i) => (
                <div
                  className="column-icon-trusted-shop w-col w-col-2 w-col-small-small-stack"
                  key={i}
                >
                  <a href={item.linkTo} className="link-badges w-inline-block">
                    <img
                      src={item.backgroundImage.file.url}
                      height="75"
                      alt=""
            ...
            <div className="column-icon-trusted-shop w-col w-col-3 w-col-small-small-stack">
              <div className="div-block-215">
                <div className="text-block-21">
                  {section9.subSections.slice(-1)[0].body.body}
                </div>
                <a
                  href="/auszeichnungen"
                  className="link-badges w-inline-block w-clearfix"
                >
                  <img
                    src={
                      section9.subSections.slice(-1)[0].backgroundImage.file.url
                    }
                    height="42"
                    alt="certificates-item"
                    className="image-58"
          ...
          <div className="columns-trusted-shop-small hide w-row">
            <div className="column-icon-trusted-shop-2 w-col w-col-3">
              <a href="#" className="link-badges w-inline-block">
                <img
                  src="https://assets-global.website-files.com/5a857fcd20c95100013eacc2/5c669f452f71d6889deb1d5b_Siegel-Fair-Unterwegs-Movinga.png"
                  height="75"
                  alt=""
            ...
            <div className="column-icon-trusted-shop-2 w-col w-col-3">
              <div className="div-block-215">
                <div className="text-block-21">Bekannt aus dem TV</div>
                <a href="#" className="link-badges w-inline-block w-clearfix">
                  <img
